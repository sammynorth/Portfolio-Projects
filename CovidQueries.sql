...
Skills used: Joins, CTE's, Windows Functions, Aggregate Functions, Temp Tables, Views
*/
...
GO
Create View GlobalVaxCounts as
...
Join dbo.covid_vax as vac
	On dea.location = vac.location
	and dea.date = vac.date
where dea.continent is not null 
GO

select * from GlobalVaxCounts